...
describe('Test Case 14 - Place Order: Register while Checkout', () => {
    it('Should place an order while registrating and deleting a new user', () => {
        ...
        Signup.setField(Signup.FieldId.newPassword, 'password')
        Signup.setField(Signup.FieldId.firstName, 'pippo')
        Signup.setField(Signup.FieldId.lastName, 'franco')
        Signup.setField(Signup.FieldId.address, 'street')
        Signup.setField(Signup.FieldId.state, 'state')
        Signup.setField(Signup.FieldId.city, 'city')
        Signup.setField(Signup.FieldId.zipCode, '12345')
        Signup.setField(Signup.FieldId.mobileNumber, '12345678')
